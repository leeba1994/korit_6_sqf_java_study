...
//        };
        ...
        Function<String, Integer> fx = s -> Integer.parseInt(s);     //String s 자료형을 parseInt 통해 int 자료형으로 리턴

        Integer num = fx.apply("10");
        System.out.println("num: " + num);
        Integer num2 = fx.andThen(result -> result + 100).apply("10");      //apply 이후 andThen 실행, andThen 중복가능
